...
pub extern "C" fn sys_bigint(
    ...
    unsafe {
        let result_ptr = result.cast::<u32>();
        let x_ptr = x.cast::<u32>();
        let y_ptr = y.cast::<u32>();
        let concat_ptr = concat_y_modulus.as_mut_ptr().cast::<u32>();
        ...
        core::ptr::copy(x.cast::<u32>(), result_ptr, BIGINT_WIDTH_WORDS);
