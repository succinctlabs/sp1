...
#[allow(unused_variables)]
#[no_mangle]
/// Decompresses a compressed Edwards point. The second half of the input slice should contain the
/// compressed Y point with the final bit as the sign bit. The first half of the input slice will
