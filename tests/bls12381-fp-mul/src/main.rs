...
fn mul(lhs: &[u64; 6], rhs: &[u64; 6]) -> [u64; 6] {
    unsafe {
        ...
        syscall_bls12381_fp_mulmod(lhs_transmuted.as_mut_ptr(), rhs_transmuted.as_ptr());
...
pub fn main() {
    ...
    for _ in 0..10 {
        ...
        assert_eq!(
            ...
            u64_6_to_biguint(&mul(&a, &b)) % &modulus
        );
        ...
        assert_eq!(
            ...
            u64_6_to_biguint(&mul(&a, &zero)) % &modulus
        );
        ...
        assert_eq!(
            ...
            u64_6_to_biguint(&mul(&a, &one)) % &modulus
        );
    }
