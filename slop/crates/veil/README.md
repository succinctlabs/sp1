...
4. **Putting it together**:
   - **Mask counting**: `let mask_length = compute_mask_length::<GC, _>(num_encoding_variables, verify)` — dry-run the unified `verify` pass on a counting context to determine the number of masks needed.
