...
This crate builds on [Plonky3](https://github.com/Plonky3/Plonky3), which is licensed
under MIT/Apache-2.0.

The Poseidon2 round constants for the BN254 scalar field (width 3) used by this crate
were generated by Horizen Labs and are copied verbatim from the
[`zkhash`](https://github.com/HorizenLabs/poseidon2) reference implementation
(authored by Markus Schofnegger and Roman Walch), which is also dual-licensed under
MIT/Apache-2.0.
