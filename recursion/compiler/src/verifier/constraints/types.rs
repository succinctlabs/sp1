...
mod tests {
    ...
    use crate::prelude::{ExtConst, Var};
    ...
    fn domain_assertions<F: TwoAdicField, C: Config<N = F, F = F>>(
        ...
        let log_d_val = domain_val.log_n as u32;
        let g_val = F::two_adic_generator(domain_val.log_n);
        // Initialize a domain.
        let domain = TwoAdicMultiplicativeCoset::<C> {
            log_n: builder
                .eval::<Var<_>, _>(C::F::from_canonical_u32(log_d_val))
                .into(),
            size: builder
                .eval::<Var<_>, _>(C::F::from_canonical_u32(1 << (log_d_val)))
                .into(),
            shift: builder.eval(domain_val.shift),
    ...
    fn test_domain() {
        ...
        for i in 0..5 {
            ...
            for dom_val in qc_domains_val.iter() {
                domain_assertions(&mut builder, dom_val, zeta_val);
            }
        }
