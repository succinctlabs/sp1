...
// version.
func New(ctx context.Context, circuitBucket, circuitType, circuitVersion string) (*Server, error) {
	r1cs, pk, err := LoadCircuit(ctx, circuitBucket, circuitType, circuitVersion)
	if err != nil {
