...
//     use sp1_core::stark::{
//         DefaultProver, MachineVerificationError, RiscvAir, StarkGenericConfig, StarkProver,
//     };
//     use sp1_core::utils::{BabyBearPoseidon2, SP1CoreOpts};
//     use sp1_core::{io::SP1Stdin, runtime::Program, stark::Challenge};
...
//         let recursive_prover = DefaultProver::new(recursive_machine);
//         let (rec_pk, rec_vk) = recursive_prover.setup(&recursive_program);

//         // Make the deferred program.
//         let deferred_program = SP1DeferredVerifier::<InnerConfig, SC, _>::build(&recursive_machine);
//         let (_, deferred_vk) = recursive_prover.setup(&deferred_program);
...
//                     let mut recursive_challenger = recursive_machine.config().challenger();
//                     let mut proof = recursive_prover
//                         .prove(
//                             &reduce_pk,
//                             vec![runtime.record],
//                             &mut recursive_challenger,
