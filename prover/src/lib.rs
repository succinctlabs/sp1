...
pub struct SP1Prover<C: SP1ProverComponents = DefaultProverComponents> {
    ...
    /// The keys for the recursion step, lazy-initialized.
    pub rec_keys: OnceLock<(StarkProvingKey<InnerSC>, StarkVerifyingKey<InnerSC>)>,

    /// The keys for the deferred step, lazy-initialized.
    pub deferred_keys: OnceLock<(StarkProvingKey<InnerSC>, StarkVerifyingKey<InnerSC>)>,

    /// The keys for the compress step, lazy-initialized.
    pub compress_keys: OnceLock<(StarkProvingKey<InnerSC>, StarkVerifyingKey<InnerSC>)>,

    /// The keys for the shrink step, lazy-initialized.
    pub shrink_keys: OnceLock<(StarkProvingKey<InnerSC>, StarkVerifyingKey<InnerSC>)>,

    /// The keys for the wrap step, lazy-initialized.
