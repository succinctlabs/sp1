...
mod tests {
    ...
    fn generate_trace() {
        ...
        shard.lt_events = vec![AluEvent::new(0, 1, Opcode::SLT, 0, 3, 2)];
    ...
    fn prove_babybear_slt() {
        ...
        shard.lt_events = vec![
            ...
            // 1 == 2 < 3
            AluEvent::new(0, 0, Opcode::SLT, 1, 2, 3),
            // 0 == 5 < -3
            AluEvent::new(0, 0, Opcode::SLT, 0, 5, NEG_3),
            // 1 == -3 < 5
            AluEvent::new(0, 0, Opcode::SLT, 1, NEG_3, 5),
            // 0 == -3 < -4
            AluEvent::new(0, 0, Opcode::SLT, 0, NEG_3, NEG_4),
            // 1 == -4 < -3
            AluEvent::new(0, 0, Opcode::SLT, 1, NEG_4, NEG_3),
            // 0 == 3 < 3
            AluEvent::new(0, 0, Opcode::SLT, 0, 3, 3),
            // 0 == -3 < -3
            AluEvent::new(0, 0, Opcode::SLT, 0, NEG_3, NEG_3),
        ];
    ...
    fn prove_babybear_sltu() {
        ...
        shard.lt_events = vec![
            ...
            // 1 == 2 < 3
            AluEvent::new(0, 0, Opcode::SLTU, 1, 2, 3),
            // 0 == LARGE < 5
            AluEvent::new(0, 0, Opcode::SLTU, 0, LARGE, 5),
            // 1 == 5 < LARGE
            AluEvent::new(0, 0, Opcode::SLTU, 1, 5, LARGE),
            // 0 == 0 < 0
            AluEvent::new(0, 0, Opcode::SLTU, 0, 0, 0),
            // 0 == LARGE < LARGE
            AluEvent::new(0, 0, Opcode::SLTU, 0, LARGE, LARGE),
        ];
