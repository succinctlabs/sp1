...
pub mod tests {
    ...
    use sp1_executor::programs::tests::fibonacci_program;
    use sp1_executor::programs::tests::simple_memory_program;
    use sp1_executor::programs::tests::{simple_program, ssz_withdrawals_program};
    use sp1_executor::Instruction;
