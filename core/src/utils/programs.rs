...
pub mod tests {
    ...
    pub const IO_ELF: &[u8] =
        include_bytes!("../../../programs/demo/io/elf/riscv32im-curta-zkvm-elf");
    ...
    pub const CYCLE_TRACKER_ELF: &[u8] =
        include_bytes!("../../../programs/test/cycle-tracker/elf/riscv32im-curta-zkvm-elf");

    pub const ED_ADD_ELF: &[u8] =
        include_bytes!("../../../programs/test/ed-add/elf/riscv32im-curta-zkvm-elf");

    pub const ED_DECOMPRESS_ELF: &[u8] =
        include_bytes!("../../../programs/test/ed-decompress/elf/riscv32im-curta-zkvm-elf");
    ...
    pub const KECCAK_PERMUTE_ELF: &[u8] =
        include_bytes!("../../../programs/test/keccak-permute/elf/riscv32im-curta-zkvm-elf");
    ...
    pub const SHA_COMPRESS_ELF: &[u8] =
        include_bytes!("../../../programs/test/sha-compress/elf/riscv32im-curta-zkvm-elf");

    pub const SHA_EXTEND_ELF: &[u8] =
        include_bytes!("../../../programs/test/sha-extend/elf/riscv32im-curta-zkvm-elf");

    pub const SHA2_ELF: &[u8] =
        include_bytes!("../../../programs/test/sha2/elf/riscv32im-curta-zkvm-elf");

    pub const BLAKE3_COMPRESS_ELF: &[u8] =
        include_bytes!("../../../programs/test/blake3-compress/elf/riscv32im-curta-zkvm-elf");
}
