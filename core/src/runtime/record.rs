...
use crate::{
    ...
    alu::AluEvent,
    bytes::{
        event::{add_sharded_byte_lookup_events, ByteRecord},
        ByteLookupEvent,
    },
    cpu::CpuEvent,
...
impl ExecutionRecord {
    ...
    pub fn split(&mut self, last: bool, opts: SplitOpts) -> Vec<ExecutionRecord> {
        ...
        split_events!(self, keccak_permute_events, shards, opts.keccak_split_threshold, last);
        split_events!(self, secp256k1_add_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, secp256k1_double_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, bn254_add_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, bn254_double_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, bls12381_add_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, bls12381_double_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, sha_extend_events, shards, opts.sha_extend_split_threshold, last);
        split_events!(self, sha_compress_events, shards, opts.sha_compress_split_threshold, last);
        split_events!(self, ed_add_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, ed_decompress_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, k256_decompress_events, shards, opts.deferred_shift_threshold, last);
        split_events!(self, uint256_mul_events, shards, opts.deferred_shift_threshold, last);
        split_events!(
            self,
        ...
        if last {
            ...
            for mem_chunks in self
                ...
                .zip_longest(self.memory_finalize_events.chunks(opts.memory_split_threshold))
            {
