...
use crate::syscall::precompiles::blake2b::Blake2bCompressInnerChip;
...
pub enum SyscallCode {
    ...
    /// Executes the `BLAKE2B_COMPRESS_INNER` precompile.
    BLAKE2B_COMPRESS_INNER = 0x00_38_01_20,
}
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_38_01_20 => SyscallCode::BLAKE2B_COMPRESS_INNER,
...
pub fn default_syscall_map() -> HashMap<SyscallCode, Rc<dyn Syscall>> {
    ...
    syscall_map.insert(
        SyscallCode::BLAKE2B_COMPRESS_INNER,
        Rc::new(Blake2bCompressInnerChip::new()),
    );
    syscall_map.insert(
    ...
    fn test_syscall_consistency_zkvm() {
        for code in SyscallCode::iter() {
            match code {
                ...
                SyscallCode::BLAKE2B_COMPRESS_INNER => {
                    assert_eq!(code as u32, sp1_zkvm::syscalls::BLAKE2B_COMPRESS_INNER)
                }
            }
        }
    }
