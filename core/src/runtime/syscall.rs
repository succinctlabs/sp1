...
pub enum SyscallCode {
    ...
    /// Executes the `BLS12381_FP2MUL` precompile.
    BLS12381_FP2MUL = 0x00_01_01_22,
}
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_01_01_22 => SyscallCode::BLS12381_FP2MUL,
    ...
    fn test_syscall_consistency_zkvm() {
        for code in SyscallCode::iter() {
            match code {
                ...
                SyscallCode::BLS12381_FP2MUL => {
                    assert_eq!(code as u32, sp1_zkvm::syscalls::BLS12381_FP2MUL)
                }
                SyscallCode::SECP256K1_DECOMPRESS => {
