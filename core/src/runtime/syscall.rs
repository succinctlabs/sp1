...
use crate::utils::ec::weierstrass::{bn254::Bn254, secp256k1::Secp256k1, secp256r1::Secp256r1};
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_01_01_10 => SyscallCode::SECP256R1_ADD,
            0x00_00_01_11 => SyscallCode::SECP256R1_DOUBLE,
