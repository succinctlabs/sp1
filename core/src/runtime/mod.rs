...
pub struct Runtime {
    ...
    /// A detailed collection of each occurance of opcodes during
    /// program execution
    pub opcode_log: HashMap<Opcode, u64>,
    /// A detailed collection of each occurance of syscalls during
    /// program execution
    pub syscall_log: HashMap<SyscallCode, u64>,
}
...
impl Runtime {
    ...
    pub fn new(program: Program, opts: SP1CoreOpts) -> Self {
        ...
        Self {
            ...
            emit_events: true,
            max_syscall_cycles,
            opcode_log: HashMap::new(),
            syscall_log: HashMap::new(),
        }
    }
    ...
    fn execute_instruction(&mut self, instruction: Instruction) -> Result<(), ExecutionError> {
        ...
        match instruction.opcode {
            ...
            Opcode::ECALL => {
                ...
                *self.syscall_log.entry(syscall).or_insert(0) += 1;
