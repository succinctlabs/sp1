...
///           [1, 1, 4, 6]];
///   ```
fn m4_permute_mut<AF: AbstractField>(input: &mut [AF; 4]) {
...
fn matmul_m4<AF: AbstractField, const NUM_WORDS_STATE: usize>(input: &mut [AF; NUM_WORDS_STATE]) {
    input
        .chunks_exact_mut(4)
