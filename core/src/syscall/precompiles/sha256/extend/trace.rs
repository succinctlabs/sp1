        ...
        for i in 0..input.sha_extend_events.len() {
            ...
            for j in 0..48usize {
                ...
                let w_i_minus_15_rr_7 =
                    cols.w_i_minus_15_rr_7.populate(output, shard, event.channel, w_i_minus_15, 7);
                ...
                let w_i_minus_15_rs_3 =
                    cols.w_i_minus_15_rs_3.populate(output, shard, event.channel, w_i_minus_15, 3);
                ...
                let w_i_minus_2_rr_17 =
                    cols.w_i_minus_2_rr_17.populate(output, shard, event.channel, w_i_minus_2, 17);
                let w_i_minus_2_rr_19 =
                    cols.w_i_minus_2_rr_19.populate(output, shard, event.channel, w_i_minus_2, 19);
                let w_i_minus_2_rs_10 =
                    cols.w_i_minus_2_rs_10.populate(output, shard, event.channel, w_i_minus_2, 10);
                ...
                cols.s2.populate(output, shard, event.channel, w_i_minus_16, s0, w_i_minus_7, s1);

                cols.w_i.populate(event.channel, event.w_i_writes[j], &mut new_byte_lookup_events);
