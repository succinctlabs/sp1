...
impl<F: PrimeField32> K256DecompressCols<F> {
    pub fn populate<H: Host>(&mut self, event: K256DecompressEvent, host: &mut H) {
...
impl<F: PrimeField32, H: Host<Record = ExecutionRecord>> ExecutionAir<F, H> for K256DecompressChip {
