...
pub struct Sha512ExtendCols<T> {
    ...
    pub w_i_minus_15_rr_1: FixedRotateRightOperation<T>,
    pub w_i_minus_15_rr_8: FixedRotateRightOperation<T>,
    pub w_i_minus_15_rs_7: FixedShiftRightOperation<T>,
    ...
    pub w_i_minus_2_rr_61: FixedRotateRightOperation<T>,
    pub w_i_minus_2_rs_6: FixedShiftRightOperation<T>,
