...
pub const SHA512_COMPRESS_K: [u32; 80] = [
    0x428a2f98d728ae22,
    0x7137449123ef65cd,
    0xb5c0fbcfec4d3b2f,
    0xe9b5dba58189dbbc,
...
/// Implements the SHA compress operation which loops over 0 = [0, 39] and modifies A-H in each
/// iteration. The inputs to the syscall are a pointer to the 80 word array W and a pointer to the 8
/// word array H.
///
