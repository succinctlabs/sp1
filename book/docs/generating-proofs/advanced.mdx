...
We recommend that during the development of large programs (> 1 million cycles) you avoid generating proofs every time.
...
If your program executes successfully, proof generation should also succeed! (Unless there is a bug in our zkVM implementation.)
...
your machine has. A higher value increases memory usage but improves speed.
