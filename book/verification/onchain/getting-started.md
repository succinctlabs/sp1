...
- The template [script](https://github.com/succinctlabs/sp1-project-template/blob/main/program/src/main.rs) shows how to generate the proof using the SDK and save it to a file.
