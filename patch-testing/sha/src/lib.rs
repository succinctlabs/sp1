...
fn test_sha2_expected_digest_lte_100_times(stdin: &mut sp1_sdk::SP1Stdin) -> impl FnOnce(SP1PublicValues) {
...
fn test_sha3_expected_digest_lte_100_times(stdin: &mut sp1_sdk::SP1Stdin) -> impl FnOnce(SP1PublicValues) {
    use sha3::Digest;
    use sha3::Sha3_256;
