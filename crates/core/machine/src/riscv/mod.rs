...
impl<F: PrimeField32> RiscvAir<F> {
    ...
    pub fn get_chips_and_costs() -> (Vec<Chip<F, Self>>, HashMap<RiscvAirDiscriminants, u64>) {
        ...
        let addmul = Chip::new(RiscvAir::AddMul(AddMulChip::default()));
        costs.insert(RiscvAirDiscriminants::AddMul, addmul.cost());
        chips.push(addmul);
    ...
    pub(crate) fn syscall_code(&self) -> SyscallCode {
        match self {
            ...
            Self::AddMul(_) => SyscallCode::ADDMUL,
