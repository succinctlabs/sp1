    ...
    fn default() -> Self {
        ...
        let core_shapes = [
            ...
            CoreShapeSpec {
                ...
                bitwise_height: vec![None, Some(14)],
                shift_right_height: vec![None, Some(14)],
                shift_left_height: vec![None, Some(14)],
                syscall_core_height: vec![None, Some(14)],
                memory_local_height: vec![Some(14)],
                mul_height: vec![None, Some(14)],
                divrem_height: vec![None, Some(14)],
            ...
            CoreShapeSpec {
                ...
                shift_right_height: vec![None, Some(15)],
                shift_left_height: vec![None, Some(15)],
                syscall_core_height: vec![Some(15)],
                memory_local_height: vec![None, Some(15)],
                mul_height: vec![None, Some(15)],
                divrem_height: vec![None, Some(15)],
                is_potentially_maximal: false,
            },
            CoreShapeSpec {
                ...
                syscall_core_height: vec![None, Some(16)],
                memory_local_height: vec![Some(16)],
                mul_height: vec![None, Some(16)],
                divrem_height: vec![None, Some(16)],
                is_potentially_maximal: false,
            },
            CoreShapeSpec {
                ...
                syscall_core_height: vec![None, Some(17)],
                memory_local_height: vec![Some(17)],
                mul_height: vec![None, Some(17)],
                divrem_height: vec![None, Some(17)],
                is_potentially_maximal: false,
            },
            CoreShapeSpec {
                ...
                syscall_core_height: vec![None, Some(18)],
            ...
            CoreShapeSpec {
                ...
                lt_height: vec![Some(16)],
                bitwise_height: vec![Some(16)],
                shift_right_height: vec![None, Some(16)],
                shift_left_height: vec![None, Some(16)],
                syscall_core_height: vec![None, Some(16)],
                memory_local_height: vec![Some(16)],
                mul_height: vec![None, Some(16)],
                divrem_height: vec![None, Some(16)],
            ...
            CoreShapeSpec {
                ...
                mul_height: vec![None, Some(19)],
                divrem_height: vec![None, Some(19)],
                is_potentially_maximal: false,
            },
