...
pub mod tests {
    ...
    pub fn simple_memory_program() -> Program {
        let instructions = vec![
            Instruction::new(Opcode::ADD, 29, 0, 0x12, false, true),
            Instruction::new(Opcode::MUL, 29, 29, 0x100, false, true),
            Instruction::new(Opcode::ADD, 29, 29, 0x34, false, true),
            Instruction::new(Opcode::MUL, 29, 29, 0x100, false, true),
            Instruction::new(Opcode::ADD, 29, 29, 0x87, false, true),
            Instruction::new(Opcode::MUL, 29, 29, 0x100, false, true),
            Instruction::new(Opcode::ADD, 29, 29, 0x65, false, true),
            // SW and LW
            Instruction::new(Opcode::SW, 29, 0, 0x20, false, true),
            Instruction::new(Opcode::LW, 28, 0, 0x20, false, true),
            // LBU
            Instruction::new(Opcode::LBU, 27, 0, 0x20, false, true),
            Instruction::new(Opcode::LBU, 26, 0, 0x21, false, true),
            Instruction::new(Opcode::LBU, 25, 0, 0x22, false, true),
            Instruction::new(Opcode::LBU, 24, 0, 0x23, false, true),
            // LB
            Instruction::new(Opcode::LB, 23, 0, 0x20, false, true),
            Instruction::new(Opcode::LB, 22, 0, 0x21, false, true),
            // LHU
            Instruction::new(Opcode::LHU, 21, 0, 0x20, false, true),
            Instruction::new(Opcode::LHU, 20, 0, 0x22, false, true),
            // LH
            Instruction::new(Opcode::LH, 19, 0, 0x20, false, true),
            Instruction::new(Opcode::LH, 18, 0, 0x22, false, true),
            // SB
            Instruction::new(Opcode::ADD, 17, 0, 0x38, false, true),
            Instruction::new(Opcode::MUL, 17, 17, 0x100, false, true),
            Instruction::new(Opcode::ADD, 17, 17, 0x27, false, true),
            Instruction::new(Opcode::MUL, 17, 17, 0x100, false, true),
            Instruction::new(Opcode::ADD, 17, 17, 0x65, false, true),
            Instruction::new(Opcode::MUL, 17, 17, 0x100, false, true),
            Instruction::new(Opcode::ADD, 17, 17, 0x25, false, true),
            // Save the value 0x12348765 into address 0x30
            Instruction::new(Opcode::SW, 29, 0, 0x30, false, true),
            Instruction::new(Opcode::SB, 17, 0, 0x30, false, true),
            Instruction::new(Opcode::LW, 16, 0, 0x30, false, true),
            Instruction::new(Opcode::SB, 17, 0, 0x31, false, true),
            Instruction::new(Opcode::LW, 15, 0, 0x30, false, true),
            Instruction::new(Opcode::SB, 17, 0, 0x32, false, true),
            Instruction::new(Opcode::LW, 14, 0, 0x30, false, true),
            Instruction::new(Opcode::SB, 17, 0, 0x33, false, true),
            Instruction::new(Opcode::LW, 13, 0, 0x30, false, true),
            // SH
            // Save the value 0x12348765 into address 0x30
            Instruction::new(Opcode::SW, 29, 0, 0x30, false, true),
            Instruction::new(Opcode::SH, 17, 0, 0x30, false, true),
            Instruction::new(Opcode::LW, 12, 0, 0x30, false, true),
            Instruction::new(Opcode::SH, 17, 0, 0x32, false, true),
            Instruction::new(Opcode::LW, 11, 0, 0x30, false, true),
        ];
        Program::new(instructions, 0, 0)
    }
}
