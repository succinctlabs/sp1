...
use sp1_gpu_cudart::sys::{MemoryGlobalGpuEvent, MemoryLocalGpuEvent};
use sp1_gpu_cudart::{
    args, DeviceMle, TaskScope, TracegenRiscvMemoryGlobalKernel, TracegenRiscvMemoryLocalKernel,
};
...
mod tests {
    ...
    use sp1_core_executor::{
        events::{MemoryInitializeFinalizeEvent, MemoryLocalEvent, MemoryRecord},
        ExecutionRecord,
    };
