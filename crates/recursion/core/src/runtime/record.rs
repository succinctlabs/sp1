...
use super::{
    ...
    MemEvent, Poseidon2Event, RecursionProgram, RecursionPublicValues, SelectDigestEvent,
};
...
pub struct ExecutionRecord<F> {
    ...
    pub select_digest_events: Vec<SelectDigestEvent<F>>,
...
impl<F: PrimeField32> MachineRecord for ExecutionRecord<F> {
    ...
    fn append(&mut self, other: &mut Self) {
        ...
        *mem_const_count += other.mem_const_count;
        ...
        select_digest_events.append(&mut other.select_digest_events);
