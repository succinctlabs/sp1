...
use sp1_hypercube::{air::MachineAir, GKR_GRINDING_BITS, MAX_CONSTRAINT_DEGREE};
use sp1_primitives::{
    fri_params::{
...
# Auto-generated by `cargo run -p sp1-prover --bin gen_soundcalc_toml`.
...
",
        ...
        recursion_trace_columns = rec.trace_columns,
        recursion_num_constraints = rec.num_constraints,
        recursion_num_lookups_m = rec.num_lookups_m,
        recursion_num_columns_s = rec.num_columns_s,
    );
