...
mod tests {
    ...
    async fn test_find_recursion_shape() {
        ...
        // Write to the compress shape file appropriate for the current feature state.
        // `mprotect` OFF writes `compress_shape.json`; `mprotect` ON writes
        // `compress_shape_mprotect.json`.
        #[cfg(not(feature = "mprotect"))]
        let output_path = "compress_shape.json";
        #[cfg(feature = "mprotect")]
        let output_path = "compress_shape_mprotect.json";
