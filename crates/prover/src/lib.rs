...
pub mod tests {
    ...
    pub fn run_e2e_prover_with_options<C: SP1ProverComponents>(
        ...
        // NOTE: PLONK/BN254 is intentionally disabled in this environment.
        // Keep the Groth16 path as the supported end-to-end proof system.
        /*
        tracing::info!("Test the outer Plonk BN254 circuit");
