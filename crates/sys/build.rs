...
fn cbindgen_builder() -> cbindgen::Builder {
    ...
    /// Header prologue with constants needed for generated types.
    const HEADER_PROLOGUE: &str = r#"
// Constants for generated types
#define WORD_SIZE 4
"#;
    ...
    cbindgen::Builder::new()
        ...
        // RISC-V AddChip types - using simplified GPU-compatible structures
        .include_item("GpuMemoryAccess")
        .include_item("AddGpuEvent")
        .include_item("AddCols")
        .include_item("CPUState")
        .include_item("RTypeReader")
        ...
        // RISC-V MemoryLocalChip types
        .include_item("MemoryLocalGpuEvent")
        // RISC-V MemoryBumpChip types
