...
pub mod prover_network_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_requester_usage(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::types::GetRequesterUsageRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::super::types::GetRequesterUsageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/network.ProverNetwork/GetRequesterUsage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("network.ProverNetwork", "GetRequesterUsage"));
            self.inner.unary(req, path, codec).await
        }
        ...
        /// Set the hart high score.
        pub async fn set_hart_high_score(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::types::SetHartHighScoreRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::super::types::SetHartHighScoreResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/network.ProverNetwork/SetHartHighScore",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("network.ProverNetwork", "SetHartHighScore"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod prover_network_server {
    ...
    pub trait ProverNetwork: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_requester_usage(
            &self,
            request: tonic::Request<super::super::types::GetRequesterUsageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::types::GetRequesterUsageResponse>,
            tonic::Status,
        >;
        ...
        async fn set_hart_high_score(
            &self,
            request: tonic::Request<super::super::types::SetHartHighScoreRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::types::SetHartHighScoreResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/network.ProverNetwork/GetRequesterUsage" => {
                    #[allow(non_camel_case_types)]
                    struct GetRequesterUsageSvc<T: ProverNetwork>(pub Arc<T>);
                    impl<
                        T: ProverNetwork,
                    > tonic::server::UnaryService<
                        super::super::types::GetRequesterUsageRequest,
                    > for GetRequesterUsageSvc<T> {
                        type Response = super::super::types::GetRequesterUsageResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProverNetwork>::get_requester_usage(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetRequesterUsageSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/network.ProverNetwork/SetHartHighScore" => {
                    #[allow(non_camel_case_types)]
                    struct SetHartHighScoreSvc<T: ProverNetwork>(pub Arc<T>);
                    impl<
                        T: ProverNetwork,
                    > tonic::server::UnaryService<
                        super::super::types::SetHartHighScoreRequest,
                    > for SetHartHighScoreSvc<T> {
                        type Response = super::super::types::SetHartHighScoreResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProverNetwork>::set_hart_high_score(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetHartHighScoreSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
