...
pub struct SP1ProofWithPublicValues {
    ...
    /// The number of cycles the proof was generated for.
...
impl SP1ProofWithPublicValues {
    ...
    pub(crate) const fn new(
        ...
        Self { proof, public_values, sp1_version, tee_proof: None, cycles }
    }
    ...
    pub fn create_mock_proof(
        ...
        match mode {
            ...
            SP1ProofMode::Compressed => {
                ...
                SP1ProofWithPublicValues { proof, public_values, sp1_version, tee_proof: None, cycles: None }
            }
