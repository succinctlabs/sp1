...
use crate::{
    private::prover::PrivateProver,
    utils::{block_on, sp1_dump},
    SP1ProofMode, SP1ProofWithPublicValues,
};

/// A builder for creating a proof request to the private infra.
pub struct PrivateProveBuilder<'a> {
    pub(crate) prover: &'a PrivateProver,
