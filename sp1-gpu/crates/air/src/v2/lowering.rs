...
//!
//! v1 ships Sequential + ColumnTile. ListScheduled and TermExpanded are
//! sketched as variants but their plan builders are deferred (Phase 5).

use crate::v2::analysis::{ConstraintInfo, ConstraintShape};
use crate::v2::chunker::Chunk;
use crate::v2::dag::{ConstraintDag, NodeId};
...
fn children(node: &crate::v2::dag::DagNode) -> [Option<NodeId>; 2] {
...
fn is_arithmetic(node: &crate::v2::dag::DagNode) -> bool {
    use crate::v2::dag::DagNode::*;
    !matches!(
        node,
        InputLeaf { .. }
