...
use crate::v2::bytecode::LeafRef;
use crate::v2::chunker::Chunk;
use crate::v2::dag::{ConstraintDag, DagNode, TraceSource};
use crate::v2::lowering::ColumnTilePlan;
use crate::F;
...
pub fn lower_column_tile(
    ...
    let mut bc = ColumnTileBytecode::default();
