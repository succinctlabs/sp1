...
//!
//! Replaces `BlockAir`'s manual decomposition. Given the per-constraint
//! analysis, packs constraints into chunks bounded by a register-pressure
...
use crate::v2::analysis::{ColumnLeaf, ConstraintInfo, ConstraintShape};
...
mod tests {
    ...
    fn cinfo(idx: usize, cols: &[u32], work: u32, depth: u32) -> ConstraintInfo {
        ...
        ConstraintInfo {
            constraint_idx: idx,
            root: 0,
            field: crate::v2::dag::ConstraintField::Base,
