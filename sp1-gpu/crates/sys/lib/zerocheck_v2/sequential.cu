...
#include "zerocheck_v2/sequential.cuh"
#include "config.cuh"
...
__global__ void zerocheck_v2_sequential(
...
template <typename K, int MAX_REGS>
__global__ void zerocheck_v2_fused_sequential(
...
extern "C" void* zerocheck_v2_sequential_kb_32_kernel() {
    return (void*)zerocheck_v2_sequential<felt_t, 32>;
}
extern "C" void* zerocheck_v2_sequential_kb_64_kernel() {
    return (void*)zerocheck_v2_sequential<felt_t, 64>;
}
extern "C" void* zerocheck_v2_sequential_kb_128_kernel() {
    return (void*)zerocheck_v2_sequential<felt_t, 128>;
}
extern "C" void* zerocheck_v2_sequential_kb_256_kernel() {
    return (void*)zerocheck_v2_sequential<felt_t, 256>;
}

extern "C" void* zerocheck_v2_sequential_ext_32_kernel() {
    return (void*)zerocheck_v2_sequential<ext_t, 32>;
}
extern "C" void* zerocheck_v2_sequential_ext_64_kernel() {
    return (void*)zerocheck_v2_sequential<ext_t, 64>;
}
extern "C" void* zerocheck_v2_sequential_ext_128_kernel() {
    return (void*)zerocheck_v2_sequential<ext_t, 128>;
}
extern "C" void* zerocheck_v2_sequential_ext_256_kernel() {
    return (void*)zerocheck_v2_sequential<ext_t, 256>;
}
