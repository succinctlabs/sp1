...
#include "zerocheck_v2/column_tile.cuh"
...
template <typename K>
__global__ void zerocheck_v2_column_tile(
...
extern "C" void* zerocheck_v2_column_tile_kb_kernel() {
    return (void*)zerocheck_v2_column_tile<felt_t>;
}

extern "C" void* zerocheck_v2_column_tile_ext_kernel() {
    return (void*)zerocheck_v2_column_tile<ext_t>;
}
