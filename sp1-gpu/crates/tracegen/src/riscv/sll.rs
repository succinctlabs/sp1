...
use sp1_core_machine::{
    ...
    alu::sll::{ShiftLeftChip, ShiftLeftCols, NUM_SHIFT_LEFT_COLS_SUPERVISOR, ShiftLeftWitgenInput, NUM_SHIFT_LEFT_WITGEN_INPUTS},
    SupervisorMode,
};
...
pub(crate) fn pack_sll_inputs(events: &[(AluEvent, ALUTypeRecord)]) -> Vec<u64> {
    ...
    inputs.par_chunks_mut(NUM_SHIFT_LEFT_WITGEN_INPUTS).zip(events.par_iter()).for_each(|(chunk, (alu, r))| {
